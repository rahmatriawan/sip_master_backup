...
<head>
  ...
  <!-- daterange picker -->
<!--  <link rel="stylesheet" href="<?php //echo base_url('/assets/templates/AdminLTE-2.4.3/bower_components/bootstrap-daterangepicker/daterangepicker.css') ?>">-->
  <!-- bootstrap datepicker -->
  <link rel="stylesheet" href="<?php echo base_url('/assets/templates/AdminLTE-2.4.3/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') ?>">
  ...
  <!-- Select2 -->
  <link rel="stylesheet" href="<?php echo base_url('/assets/templates/AdminLTE-2.4.3/bower_components/select2/dist/css/select2.min.css') ?>">
  <!-- Theme style -->
